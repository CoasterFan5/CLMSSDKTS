...
export enum AccountDomainLookupsApiApiKeys {
}

export class AccountDomainLookupsApi {
    ...
    public setApiKey(key: AccountDomainLookupsApiApiKeys, value: string) {
        (this.authentications as any)[AccountDomainLookupsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async searchAccountDomains (name?: string, domain?: string, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/v1/accounts/search';
