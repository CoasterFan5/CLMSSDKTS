...
export const create_blackout_date_courses = async (token: string, baseUrl: string, params: {
  "course_id": string;"start_date"?: undefined;"end_date"?: undefined;"event_title"?: string
}) => {
