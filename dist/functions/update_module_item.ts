...
export const update_module_item = async (
  token: string,
  baseUrl: string,
  params: {"course_id": string;"module_id": string;"id": string;"module_item[title]"?: string;"module_item[position]"?: number;"module_item[indent]"?: number;"module_item[external_url]"?: string;"module_item[new_tab]"?: boolean;"module_item[completion_requirement][type]"?: string;"module_item[completion_requirement][min_score]"?: number;"module_item[published]"?: boolean;"module_item[module_id]"?: string},
) => {
