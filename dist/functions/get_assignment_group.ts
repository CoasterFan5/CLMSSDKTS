...
export const get_assignment_group = async (
  token: string,
  baseUrl: string,
  params: {"course_id": string;"assignment_group_id": string;"include"?: unknown;"override_assignment_dates"?: boolean;"grading_period_id"?: number},
) => {
