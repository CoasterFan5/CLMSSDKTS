...
export const index_of_active_global_notification_for_user = async (
  token: string,
  baseUrl: string,
  params: {"account_id": string;"include_past"?: boolean;"include_all"?: boolean;"show_is_closed"?: boolean},
) => {
